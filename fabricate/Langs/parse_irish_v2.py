...
porder = open("Irish_v5_porder.txt").read().decode('utf-8').split()
    ...
    for i in range(N):
        ...
        if this_score < min_score:
            ...
            if this_score < best_score:
                ...
                best_order = order[:]
                if this_score < 129:
                    best_layout = layout(add_space(crunch(best_order)))
                    if best_layout not in solutions:
                        solutions.add(best_layout)
                        print best_layout
                        print
            print i, this_score, best_score
print '********************************************************************************'
print '********************************************************************************'
print
for soln in solutions:
    print soln
    print
print len(solutions), 'solution%s!' % ['', 's'][len(solutions) > 0]
